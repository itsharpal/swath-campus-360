...
const routes = {
  ...
  'dashboard.supervisor': {
    ...
    tokens: [{"old":"/supervisor/dashboard","type":0,"val":"supervisor","end":""},{"old":"/supervisor/dashboard","type":0,"val":"dashboard","end":""}],
    types: placeholder as Registry['dashboard.supervisor']['types'],
  },
  'admin.users.index': {
    methods: ["GET","HEAD"],
    pattern: '/admin/users',
