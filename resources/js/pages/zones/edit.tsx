...
import { MapPin, ChevronRight, ArrowLeft, Layers, Clock } from "lucide-react"
...
export default function EditZone() {
      ...
      onSuccess: () => {
        Swal.fire({
          ...
          html: `<span style="color:#555;font-family:'DM Sans',sans-serif;">
            <strong>${data.name}</strong> has been successfully updated.
          </span>`,
          icon: "success",
          confirmButtonColor: "#1a7a4a",
          confirmButtonText: "Back to Zones →",
          customClass: {
  ...
  if (!zone.id) {
    return (
      <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#f0fdf4", fontFamily: "DM Sans, sans-serif", color: "#16a34a" }}>
        Loading zone...
      </div>
    )
  }
  ...
  return (
    <>
      <style>{`
        ...
        .progress-bar-wrap { height: 4px; background: #f3f4f6; }
        .progress-bar-fill {
          height: 100%;
          background: linear-gradient(90deg, #f59e0b, #fbbf24);
          transition: width 0.4s ease; border-radius: 0 4px 4px 0;
        }
        .progress-header {
        ...
        .edit-banner {
          ...
          font-size: 12px; color: #a16207; font-weight: 500;
        }
        .edit-badge {
        ...
        .ez-title em { color: #f59e0b; font-style: italic; }
        .ez-sub { font-size: 13px; color: #9ca3af; margin: 0 0 28px; }
      ...
      <div className="ez-root">
        ...
        <div className="ez-card">
          ...
          <div className="edit-banner">
            ...
            Modifying zone: <strong>{zone.name}</strong>
          </div>
          ...
          <div className="ez-body">
            ...
            <div className="breadcrumb">
              ...
              <div className="breadcrumb-line" />
              <span className="breadcrumb-text">Edit Zone</span>
            </div>

            <h1 className="ez-title">Edit <em>Zone</em></h1>
            <p className="ez-sub">Update details for this registered zone.</p>
          ...
          <div className="ez-footer">
            <button className="btn-cancel" onClick={() => router.visit(`/zones/${zone.id}`)}>
              <ArrowLeft size={14} />
              Cancel
            </button>
