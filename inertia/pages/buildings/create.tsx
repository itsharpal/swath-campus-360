...
// SweetAlert2 + fonts are loaded dynamically below.
...
export default function CreateBuilding() {
  ...
  function submit(e: React.FormEvent) {
    ...
    Swal.fire({ ...swalBase,
      title: 'Saving…',
      html: '<span style="color:#4a7c59;font-size:.85rem">Registering your building in Swachh Campus…</span>',
      ...
      onSuccess: () => {
        Swal.fire({ ...swalBase,
          ...
          html: `<span style="color:#4a7c59">
            <b style="color:#15803d">${data.name}</b> has been registered successfully.
          </span>`,
          confirmButtonText: 'View All Buildings →',
          confirmButtonColor: '#16a34a',
          timer: 4000,
  ...
  function handleCancel() {
    const Swal = (window as any).Swal
    if (!data.name && !data.code && !data.description) { window.history.back(); return }
    Swal?.fire({ ...swalBase,
      icon: 'question', iconColor: '#0ea5e9',
      title: 'Discard Changes?',
      text: 'You have unsaved data. Leave anyway?',
    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .cb-prog-track {
          height: 5px; background: var(--green-pale); border-radius: 100px; overflow: hidden;
        }
        .cb-prog-fill {
        ...
        .cb-title {
          ...
          color: var(--text); letter-spacing: -.025em; line-height: 1.15; margin-bottom: .45rem;
        }
        .cb-title-accent {
          background: linear-gradient(135deg, var(--green-deep) 0%, var(--green) 40%, var(--teal) 70%, var(--sky) 100%);
        ...
        .cb-badge {
          ...
          margin-bottom: 1rem;
          font-size: .7rem; font-weight: 500; color: var(--green-deep);
          letter-spacing: .02em;
        }
        .cb-badge-dot {
        ...
        .cb-label {
          ...
          font-size: .78rem; font-weight: 500; color: var(--dim);
        ...
        .cb-input:hover, .cb-textarea:hover {
        ...
        .cb-input:focus, .cb-textarea:focus {
          ...
          background: #f0fdf4;
          box-shadow:
            0 0 0 3.5px rgba(22,163,74,.1),
            0 0 20px rgba(22,163,74,.08);
        }
        ...
        .cb-input-wrap:has(textarea:focus) .cb-glow-line {
        ...
        .cb-check {
          ...
          color: var(--check); opacity: 0; pointer-events: none;
        ...
        .cb-chars {
          ...
          font-family: 'JetBrains Mono', monospace;
          font-size: .58rem; color: var(--muted); pointer-events: none;
          transition: color .2s;
        }
        ...
        .cb-err {
          ...
          margin-top: .35rem; padding-left: 2px;
        ...
        .cb-cancel {
          ...
          border-radius: 10px; padding: .68rem 1rem;
          cursor: pointer; transition: all .2s;
        }
        .cb-cancel:hover {
          color: var(--dim); border-color: rgba(22,163,74,.2); background: var(--green-pale);
        }
        ...
        .cb-submit:hover {
          ...
          box-shadow: 0 8px 28px rgba(22,163,74,.45), 0 2px 6px rgba(0,0,0,.12), inset 0 1px 0 rgba(255,255,255,.18);
        }
        ...
        .cb-infobar {
          ...
          font-family: 'JetBrains Mono', monospace;
          font-size: .6rem; color: var(--muted); letter-spacing: .09em;
        ...
        .cb-swal-popup {
          ...
          box-shadow: 0 24px 80px rgba(22,163,74,.15), 0 4px 16px rgba(0,0,0,.08) !important;
      ...
      <div className="cb-root">
        ...
        <svg className="cb-watermark" viewBox="0 0 200 200" fill="none">
          ...
          <line x1="100" y1="110" x2="75"  y2="90"  stroke="white" strokeWidth="1.2" opacity=".3"/>
          <line x1="100" y1="110" x2="125" y2="90"  stroke="white" strokeWidth="1.2" opacity=".3"/>
          <line x1="100" y1="135" x2="80"  y2="120" stroke="white" strokeWidth="1"   opacity=".3"/>
          <line x1="100" y1="135" x2="120" y2="120" stroke="white" strokeWidth="1"   opacity=".3"/>
        </svg>
          ...
          <div className="cb-body">
            ...
            <div className="cb-header">
              ...
              <div className="cb-eyebrow">
                <span className="cb-ey-line" />
                Campus Registry
                <span className="cb-ey-line" />
              </div>
              <h1 className="cb-title">
                New <span className="cb-title-accent">Building</span>
              </h1>
              <p className="cb-sub">Register a building to the Swachh Campus management system.</p>
            </div>
                  ...
                  <div className="cb-field" key={field.key}>
                    <div className="cb-label-row">
                      <label className={`cb-label${isActive ? ' act' : ''}`}>
                        <span className="cb-licon">{field.icon}</span>
                        {field.label}
                      </label>
                    ...
                    <div className="cb-input-wrap">
                      {field.type === 'textarea' ? (
                        <>
                          ...
                          />
                          <span className={`cb-chars${val.length > 180 ? ' warn' : ''}`}>
                            {val.length}/200
                          </span>
                        </>
                      ) : (
