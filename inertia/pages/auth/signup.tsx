    ...
    <>
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sc-page {
          ...
          background:
            radial-gradient(ellipse at 15% 25%, rgba(134,239,172,0.35) 0%, transparent 55%),
            radial-gradient(ellipse at 85% 75%, rgba(74,222,128,0.2) 0%, transparent 55%),
            #edfbf3;
        ...
        .sc-input:focus { border-color: #16a34a; box-shadow: 0 0 0 3px rgba(22,163,74,0.12); background: white; }
        ...
        .sc-btn:hover { background: #15803d; transform: translateY(-1px); box-shadow: 0 6px 20px rgba(22,163,74,0.35); }
      ...
      <div className="sc-page">
        ...
        <div className="sc-card">
          ...
          <p className="sc-subtitle">Register a new account to join the campus system</p>
              ...
              <>
                <div className="sc-field">
                  <div className="sc-label-row">
                    ...
                    <span className="sc-hint">As per records</span>
                  </div>
                  <input className="sc-input" type="text" name="fullName" id="fullName"
                    placeholder="e.g. Ravi Sharma"
                    data-invalid={errors.fullName ? 'true' : undefined} />
                  {errors.fullName && <p className="sc-error">⚠ {errors.fullName}</p>}
                </div>
                ...
                <div className="sc-field">
                  ...
                  <input className="sc-input" type="email" name="email" id="email"
                    autoComplete="email" placeholder="e.g. ravi@campus.edu"
                ...
                <div className="sc-field">
                  ...
                  <input className="sc-input" type="password" name="password" id="password"
                ...
                <div className="sc-field">
                  ...
                  <input className="sc-input" type="password" name="passwordConfirmation" id="passwordConfirmation"
