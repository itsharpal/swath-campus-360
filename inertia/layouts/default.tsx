        ...
        <div>
          ...
          <div>
            <nav>
              {children.props.user ? (
                <>
                  <Link href="/complaints/create">File Complaint</Link>
                  <Link href="/complaints">Public Complaints</Link>
                ...
                <>
                  <Link route="auth.show_register">Signup</Link>
                  <Link route="auth.show_login">Login</Link>
                </>
              )}
            </nav>
          </div>
